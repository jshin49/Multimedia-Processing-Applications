...
#End Region
    ...
    Private Function pixelCompare(ByRef image1 As Bitmap, ByRef image2 As Bitmap) As Boolean
        ...
        For i As Integer = 0 To image1.Width - 1
            For j As Integer = 0 To image1.Height - 1
                If Not image1.GetPixel(i, j).Equals(image2.GetPixel(i, j)) Then
                    Return False
                End If
            Next j
        Next i
    ...
    Private Sub picImage_MouseDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles picImage.MouseDown
        RemoveDashRect()
        frmMain.currentImageIndex = 0
        While Not pixelCompare(image, frmMain.iObject(frmMain.currentImageIndex).rotatedImage)
            frmMain.currentImageIndex += 1
            If frmMain.iObject(frmMain.currentImageIndex) Is Nothing Then
                MsgBox("Cannot find matching image object")
                Exit While
            End If
        End While
    ...
    Private Sub picImage_MouseMove(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles picImage.MouseMove
        If Not selectedPoint Is Nothing Then
            frmMain.iObject(frmMain.currentImageIndex).Reset(image)
            RemoveDashRect()
    ...
    Private Sub frmImage_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        ...
        frmMain.iObject(frmMain.currentImageIndex).Close()
    End Sub
End Class